...
time=(datetime.datetime.now() - datetime.timedelta(days=1)).replace(hour=18,minute=0,second=0).strftime('%s')
newtime_two=(datetime.datetime.now() - datetime.timedelta(days=2)).replace(hour=6,minute=0,second=0).strftime('%s')
